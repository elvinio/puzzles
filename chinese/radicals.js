...
const RADICAL_GROUPS = [
  ...
  { strokes: 3, items: [
    ...
    { char: '廾', pinyin: 'gǒng', meaning: 'two hands; clasped hands', word: '弄', wordPinyin: 'nòng', wordMeaning: 'to play with; to do' },
  ...
  { strokes: 7, items: [
    ...
    { char: '疋', pinyin: 'pǐ', meaning: 'bolt of cloth; foot', word: '疑', wordPinyin: 'yí', wordMeaning: 'doubt; suspect' },
